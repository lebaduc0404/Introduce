    ...
    return (
      <>
        ...
        <p className="mt-[1em] mb-[1em] block">
          Nutrify Premium members can now define calorie and macronutrient
          intake goals and Nutrify will automatically track your progress over
          time.
        </p>
        <p className="mt-[1em] mb-[1em] block">
          When starting a goal, you can define your own calorie and
          macronutrient values or you can use Nutrify to help establish a
          baseline goal.
        </p>
        <p className="mt-[1em] mb-[1em] block">
        ...
        <p className="mt-[1em] mb-[1em] block">
          Each of these is calculated based on your body characteristics
          (height, weight, age, gender) as well as your activity level.
        </p>
        <p className="mt-[1em] mb-[1em] block">
          You’ll also see an informative page describing the what and why behind
          each calculation and amount (disclaimer: these amounts are estimates
          and should be adjusted over time when necessary).
        </p>
        <img
        ...
        <p className="mt-[1em] mb-[1em] block">
          Setting a calorie or macronutrient goal is a great way to understand
          how your current food intake matches up with your ideal intake.
        </p>
      </>
    );
};
