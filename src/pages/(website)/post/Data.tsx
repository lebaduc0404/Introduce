export const data = [
  {
    ...
    longContent: [
      ...
      "🏆 Set food-specific and category-specific goals.",
      "📔 Create a visual food diary.",
      "📈 Get trends over time and learn about your food habits.",
      "🔎 Discover new foods on your way to completing the Nutridex.",
      "🥗 Learn about the nutritional values of different foods.",
      "🍽️ Enjoy personalized meal recommendations based on your preferences.",
      "📱 Sync with fitness trackers to monitor your physical activity.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "📝 Keep a personalized food diary.",
      "💪 Monitor your progress toward your goals.",
      "📆 Plan your meals ahead of time.",
      "👥 Share your progress with friends for motivation.",
      "🎉 Join challenges to keep you engaged in your nutrition journey.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🔑 Access personalized coaching and feedback.",
      "🌈 Discover healthy recipes tailored to your dietary needs.",
      "🧘‍♀️ Explore mindfulness and wellness features.",
      "📅 Create a weekly meal plan with ease.",
      "👩‍🍳 Cook with confidence using our step-by-step guides.",
      "🥳 Celebrate milestones and achievements along your journey.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🔍 Find restaurants that cater to your dietary preferences.",
      "📈 Use advanced analytics to refine your goals.",
      "🤝 Participate in group challenges and events.",
      "🏆 Track your achievements and earn rewards.",
      "📝 Document your journey through notes and photos.",
      "🔔 Receive personalized notifications and encouragement.",
      "🔒 Ensure your data is secure and private.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🔄 Easily swap meals if you change your mind.",
      "📸 Share your meal plans with friends.",
      "🍴 Get tips on portion sizes for healthy eating.",
      "🎉 Organize family meals and events in one place.",
      "🤔 Learn about food substitutions and alternatives.",
      "📝 Keep track of leftovers to minimize waste.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "💪 Discover workouts that promote both physical and mental health.",
      "🌱 Find resources for a holistic lifestyle.",
      "🗓️ Set wellness goals alongside fitness goals.",
      "📊 Track your mental wellness progress.",
      "👥 Join community groups focused on wellness.",
      "🏕️ Participate in retreats and wellness events.",
  ...
  },
  {
    ...
    longContent: [
      ...
      "🍨 Explore low-calorie alternatives for your favorite treats.",
      "🧁 Get tips on portion control with desserts.",
      "🍎 Use fruits as natural sweeteners.",
      "🎂 Plan desserts that fit your nutrition goals.",
      "📚 Read about the science of sugar and its alternatives.",
      "🎉 Host healthy dessert parties with friends.",
      "🤤 Share your dessert creations in our community.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "📊 Track your macro and micronutrients effectively.",
      "🛒 Make informed choices while grocery shopping.",
      "📖 Access resources on food regulations.",
      "🥦 Discover the impact of food labeling on health.",
      "💡 Get tips for healthier snacking.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🥗 Understand the nutritional aspects of plant foods.",
      "🌾 Explore the environmental benefits of plant-based eating.",
      "🌱 Find local plant-based restaurants and markets.",
      "🍳 Experiment with plant-based alternatives for your favorite dishes.",
      "📚 Read success stories from plant-based eaters.",
      "🥕 Join community events focused on plant-based living.",
      "💡 Get tips for transitioning to a plant-based lifestyle.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "📈 Analyze your eating habits over time.",
      "💪 Identify areas for improvement in your diet.",
      "📅 Set reminders to log your meals.",
      "📝 Keep a daily food journal for better awareness.",
      "🤝 Share tips with friends on effective tracking.",
      "📚 Read about common tracking mistakes and how to avoid them.",
      "🎯 Set personalized tracking goals based on your lifestyle.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🍵 Learn about the benefits of herbal teas.",
      "🍋 Explore infused water recipes for flavor.",
      "🏋️‍♀️ Find out how hydration affects your performance.",
      "📅 Set hydration goals to meet your needs.",
      "📝 Keep track of your daily water consumption.",
      "💦 Learn the signs of dehydration.",
      "🌊 Join community challenges focused on hydration.",
    ],
  ...
  },
  {
    ...
    longContent: [
      ...
      "🥙 Explore protein-rich recipes for every meal.",
      "🥩 Discover plant-based protein alternatives.",
      "📖 Read success stories of athletes and fitness enthusiasts.",
      "📈 Track your protein intake effectively.",
      "💡 Get tips for optimizing protein consumption.",
      "📅 Plan protein-rich meal preps.",
      "👥 Share your favorite protein-packed meals in our community.",
    ],
